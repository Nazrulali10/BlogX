  ...
  return (
    <div className="w-full flex md:flex-row flex-col justify-center  py-10 gap-8">
      ...
      <div className="flex flex-col text-center h-fit   bg-white dark:bg-gray-900 border border-gray-300/60 rounded-xl py-10 px-6 shadow-sm max-w-lg w-full">
        ...
        <div className="flex flex-col gap-3 text-left text-gray-700 dark:text-gray-300">
          <div className="flex items-center gap-3">
            <span className="w-5 h-5 rounded-full bg-blue-800 border border-gray-400"></span>
            <p><strong>Blue</strong> – All</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-5 h-5 rounded-full bg-red-600 border border-gray-400"></span>
            <p><strong>Red</strong> – Sports</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-5 h-5 rounded-full bg-yellow-500 border border-gray-400"></span>
            <p><strong>Yellow</strong> – Technology</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-5 h-5 rounded-full bg-purple-500 border border-gray-400"></span>
            <p><strong>Purple</strong> – News</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-5 h-5 rounded-full bg-green-600 border border-gray-400"></span>
            <p><strong>Green</strong> – Cinema</p>
          </div>
        </div>
      </div>
      ...
      <form
        ...
        className="max-w-96 w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white dark:bg-gray-900 text-black dark:text-white shadow-sm"
      >
        <h1 className="text-gray-900 dark:text-white text-3xl mt-10 font-medium">Signup</h1>
        <p className="text-gray-500 text-sm mt-2">Please sign in to continue</p>

        <div className="flex flex-col gap-4 mt-5">
          <div className="flex items-center w-full border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
          ...
          <div className="flex items-center w-full border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
            <ShieldUser size={21} className="text-gray-400" />
            <input
